...
const beveragesCategory = "Beverages"
...
export default function BeveragesCategory() {
  ...
  const beveragesProducts = allProducts.filter(product => product.category === beveragesCategory)

  // List of all product categories (including current and other categories)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full sm:w-[95%] md:w-[90%] lg:w-[80%]">
        ...
        <div className="flex flex-col lg:flex-row gap-8 mb-8">
          <div className="w-full lg:w-1/4 xl:w-1/5">
            <FilterSidebar
              categories={productCategories}  // Pass all categories
              productCategories={productCategories.map(cat => cat.name)} // Use all category names
