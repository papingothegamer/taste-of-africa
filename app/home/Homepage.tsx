  ...
  return (
    <div className="bg-gray-50">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <Image
          src={importImage("west-african-food-concept-traditional-600nw-1351940339.webp") || "/placeholder.svg"}
          alt="African Food"
          layout="fill"
          objectFit="cover"
          quality={100}
        ...
        >
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            Discover the <span className="text-yellow-400">Taste of Africa</span>
          </h1>
          ...
          <Link href="/shop" passHref>
            <Button
              size="lg"
              className="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold rounded-full px-8 py-4 text-lg"
            >
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { name: "African Foods", icon: Utensils, color: "text-green-500", bgColor: "bg-green-100" },
              { name: "African Fashion", icon: ShirtIcon, color: "text-blue-500", bgColor: "bg-blue-100" },
              { name: "African Art", icon: LucideImage, color: "text-red-500", bgColor: "bg-red-100" },
            ].map((category, index) => (
              <motion.div
                key={index}
              ...
              >
                <div className="p-6">
                  <div
                    className={`w-24 h-24 mx-auto mb-4 ${category.bgColor} rounded-full flex items-center justify-center`}
                  >
            ...
            {[
              {
                ...
                image:
                  "/images/misc/isolated-shot-happy-afro-american-man-looks-away-with-glad-expression-smiles-broadly-wears-winter-hat-with-pompon-black-suit-isolated-yellow-studio-wall_273609-32834.jpg",
              },
              {
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="bg-gray-100 p-8 rounded-lg shadow-lg">
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-600 mb-4">Visit our store for a unique shopping experience!</p>
              <Link
                href="https://www.google.com/maps/search/?api=1&query=123+African+Market+Street,+Lodz,+Poland"
                passHref
              >
                <Button className="bg-green-600 hover:bg-green-700 text-white rounded-full">Get Directions</Button>
              </Link>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-b from-green-600 to-green-700 text-white rounded-lg">
        <div className="container mx-auto px-4 max-w-3xl text-center">
          ...
          <form className="flex flex-col sm:flex-row gap-4">
            ...
            <Button
              type="submit"
              className="bg-yellow-400 text-black font-semibold hover:bg-yellow-500 rounded-full px-8"
            >
              Subscribe
            </Button>
          </form>
